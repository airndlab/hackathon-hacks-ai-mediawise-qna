...
const sleepTimeout = __ENV.SLEEP_TIMEOUT
const questionType = 'llm-prompt'
const resultType = 'vllm-prompt-llm'
...
export function handleSummary(data) {
  return {
    [`reports/${resultType}/result-${k6DURATION}-${sleepTimeout}-${k6VUS}.json`]: JSON.stringify(data, null, 2),
    [`reports/${resultType}/result-${k6DURATION}-${sleepTimeout}-${k6VUS}.html`]: htmlReport(data),
  }
}
